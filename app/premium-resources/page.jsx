...
function Page() {
  ...
  const renderPlants = () => (
    <>
    {loading && <Loading/>}      <ul className='flex flex-wrap justify-center p-5 text-center mb-10'>
        <li onClick={changeCategory} id='0' className='px-4 py-2 mx-2 rounded-lg cursor-pointer transition-transform duration-300 ease-in-out bg-white text-gray-600 shadow-md hover:bg-green-300 hover:text-green-900'>Software</li>

        <li onClick={changeCategory} id='1' className='px-4 py-2 mx-2 rounded-lg cursor-pointer transition-transform duration-300 ease-in-out bg-white text-gray-600 shadow-md hover:bg-green-300 hover:text-green-900'>Courses</li>
